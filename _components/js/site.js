...
$("#top").waypoint(
  function() {
    $("#nav .outer-container #uppernav li a#link-projects").removeClass(
      "active"
    );
  },
  {
  ...
  $(window).scroll(function() {
    ...
    $(".hideme").each(function(i) {
      var bottom_of_object =
        $(this).offset().top + $(this).outerHeight() - $(window).height() / 1.3;
...
$(document).ready(function() {
  ...
  var footer = $("footer");
  // var projectHeight = document.getElementById("projects").offsetHeight; scroll_start < projectHeight
  var projectOffset = projects.offset();
  var footerOffset = footer.offset();
  $(document).scroll(function() {
    scroll_start = $(this).scrollTop();
    if (scroll_start < projectOffset.top || scroll_start > footerOffset.top) {
      $("#nav a").css("color", "#221e20");
    } else {
      $("#nav a").css("color", "#fbfbfb");
    }
  });
});
